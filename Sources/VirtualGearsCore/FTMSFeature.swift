...
public enum VirtualTrainerFTMSProfile {
    ...
    /// Range. Leaving those out, which Virtual Gears originally did because it has
    ...
    /// the device; Virtual Gears still sets resistance from gears, never ERG.
    ...
    /// Virtual Gears puts the rider in charge of the gears, so it never takes a
