...
final class HeadwindCentralService: NSObject {
    ...
    private let identityKey = "VirtualShift.headwindIdentity"
    private let speedKey = "VirtualShift.headwindManualSpeed"
    private let sensorModeKey = "VirtualShift.headwindSensorMode"
    private let controlPreferenceKey = "VirtualShift.headwindManualControl"
    ...
    init(
        ...
        let storedPreference = defaults.object(
            forKey: "VirtualShift.headwindManualControl"
        ) as? Bool
